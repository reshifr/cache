...
/**
 * \brief ChaCha20-Poly1305 configuration
 * Configuration parameters for the ChaCha20-Poly1305 algorithm are:
 * - `IV_LENGTH` (Initialization Vector Length) = 12 bytes
...
public:
  static constexpr u IV_LENGTH = 12U;
...
/**
 * \brief ChaCha20-Poly1305 cipher
...
public:
   ...
   * \param salt The salt
   */
  chacha20poly1305(const slt_t& salt) noexcept: m_salt(salt) {};
...
private:
   ...
   * \param[out] enmsg The encrypted message
